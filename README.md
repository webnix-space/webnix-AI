...
Built using Tether's [QVAC SDK](https://docs.qvac.ai) — QVAC SDK version: **0.19.1**.
...
| On-device AI runtime | [QVAC SDK](https://docs.qvac.ai) v0.19.1 |
...
```bash
git clone https://github.com/webnix-space/webnix-ai
cd webnix-ai
